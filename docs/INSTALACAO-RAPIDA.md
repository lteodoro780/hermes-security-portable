...
3. Aguarde a janela desktop abrir diretamente.
...
A janela abre diretamente. Para 16 GB de RAM, use o perfil Balanceado. A CLI continua disponível em `scripts\windows\02-iniciar-hermes.bat`.

Depois de instalar o `llama.cpp`, também é possível baixar, importar ou trocar modelos na seção **Modelos**.
